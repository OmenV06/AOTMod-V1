...
public class TitanThreeOneEntity extends Animal {
    public TitanThreeOneEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    private static void spawnRegenerationParticles(TitanThreeOneEntity titan) {

        double particleY = titan.getY() + 2.0D;

        ((ServerLevel)titan.level).sendParticles(ParticleTypes.CAMPFIRE_COSY_SMOKE,
                titan.getX(), particleY, titan.getZ(),
                12, 0.4D, 0.75D, 0.4D, 0.0D);
    }
