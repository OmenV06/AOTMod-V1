...
import net.omen.AOTMod.entity.custom.brain.TitanAttackableTargetGoal;
import net.omen.AOTMod.entity.custom.brain.TitanRandomStrollGoal;
import net.omen.AOTMod.entity.custom.brain.TitanSleepGoal;
import net.omen.AOTMod.sounds.ModSounds;
import org.jetbrains.annotations.Nullable;

import java.util.Random;

public class TitanFourTwoEntity extends Animal {
    public TitanFourTwoEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.10, false));
    ...
    private static void spawnRegenerationParticles(TitanFourTwoEntity titan) {
