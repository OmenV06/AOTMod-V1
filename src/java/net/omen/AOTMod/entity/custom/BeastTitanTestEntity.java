...
public class BeastTitanTestEntity extends Animal {
    public BeastTitanTestEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    private static void spawnRegenerationParticles(BeastTitanTestEntity titan) {
